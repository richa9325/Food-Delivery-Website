...
function Nav() {
 ...
 <div className='flex items-center gap-1 text-2xl font-extrabold tracking-wide hover:scale-105 transition-all duration-200 cursor-pointer'>
  <MdFastfood className='w-[30px] h-[30px] text-black'/>
  <span>
